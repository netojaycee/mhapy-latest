...
export default function WhyChooseMhapy() {
  return (
    <section className='relative w-full py-16 px-4 md:px-8 text-center bg-[#5A1DAD] text-white'>
      {/* Background Overlay */}
      ...
      <div className='relative grid md:grid-cols-3 gap-6 mt-10 max-w-6xl mx-auto'>
        ...
        <Card className='bg-white text-black shadow-lg rounded-lg overflow-hidden'>
          <CardContent className='p-4 md:p-6 text-center'>
            ...
            <p className='text-sm text-gray-600 mt-2'>
              Get access to a wide range of licensed professionals with various
              specializations.
            </p>
            <Button
              variant='outline'
